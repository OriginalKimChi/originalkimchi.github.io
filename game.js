...
try {
    loadedQuestions = [
        ...
        {
            "question": "How can the use of electric vehicles (EVs) help Nottingham Forest achieve its sustainability goals?",
            "correct_answer": "By reducing emissions from fan and staff travel to matches",
            "incorrect_answers": [
                "By powering the stadium through energy generated by EVs",
                "By providing a quieter alternative to gas-powered machinery",
                "By supporting community recycling programs"
            ]
        },
        {
